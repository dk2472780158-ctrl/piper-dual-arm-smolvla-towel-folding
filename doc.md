...
![png](assets/towel/cam_left.png)

**中相机（正对毛巾）：**

![png](assets/towel/cam_middle.png)

**右相机（工作台全局）：**

![png](assets/towel/cam_right.png)
...
> ✅ **对照检查**：三路画面都有图像（见 2.4 ③）、三个编号都有值 = 相机检测通过。出现 `left=` 等为空 = 相机被占用，按 4.3 处理。

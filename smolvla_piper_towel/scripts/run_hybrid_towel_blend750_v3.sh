...
RUN_DIR="$EXPERIMENT_ROOT/blend_one_click_runs_v3/$RUN_ID"
...
echo "  authority∈[0,0.9]；不合格/越界动作使authority衰减，命令平滑回到ACT"
echo "============================================================"
...
ln -sfn "$RUN_DIR" "$EXPERIMENT_ROOT/blend_one_click_runs_v3/latest"
